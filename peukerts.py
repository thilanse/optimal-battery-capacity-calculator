...
def getMonthSaving_block(capacity, new_month_data, dod, peak_rate, day_rate, off_rate, exponent):
    ...
    for row in new_month_data:
        ...
        print("Old Peak Energy: ", peak_energy)
        print("New Peak Energy: ", new_peak_energy)
        print(" ")
        print("Old Off Peak Energy: ", off_energy)
        print("New Off Peak Energy: ", new_off_energy)
        print("")
        print("Old Day Peak Energy: ", day_energy)
        print("New Day Peak Energy: ", new_day_energy)
    ...
    print("Electricity Bill: ", time_of_use)
...
def NPV_block(capacity, peak_rate, day_rate, off_rate, batt, inverter_size, dep_rate, life_time, month_data, month_energy, month_energies, dod, inflation, weights, inverter_data, exponent):
    ...
    print("Present Outflow: ", presentOutflow_value)
    ...
    print("Present Inflow: ", presentInflow_value)
...
class StartPage(Frame):
    ...
    def compute_optimum(self,entry_data_value, entry_battery_value, entry_inverter_value, entry_energies_value,
        ...
        if tariff == 'Block Tariff':
            ...
            npv, battery_time = NPV_block(480, peak_rate, day_rate, off_rate, batt, inverter_size, dep_rate,
                                          life_time, month_data, month_energy, monthly_energies, dod, inflation,
                                          weights,
                                          inverter_data, exponent)
